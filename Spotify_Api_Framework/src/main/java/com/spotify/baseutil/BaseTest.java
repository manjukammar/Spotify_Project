...
public class BaseTest {
	...
	public static final String EXCELPATH2 = sDirPath + "./src/main/resources/data/Data2.xlsx";
	...
	public static String accessToken=ExcelUtil.getCellData(EXCELPATH2, "AccessToken", 1, 1);
	...
	public synchronized void setExtentReport( Method methodName) {
     ...
     //		requestSpecBuilder = new RequestSpecBuilder().setBaseUri(prop_constants.getProperty("Base_Url"));
