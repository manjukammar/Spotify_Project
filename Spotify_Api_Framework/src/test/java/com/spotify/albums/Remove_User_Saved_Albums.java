...
public class Remove_User_Saved_Albums extends BaseTest{
...
//		ApiActionUtil.deleteMethodWithQueryParam(query_Param_Map, Endpoints.UsersavedAlbum,prop_constants.getProperty("status_code_200"), prop_constants.getProperty("content_type_json"));
//		
		ApiActionUtil.deleteMethod(queryparamkey, pathParam, ids,Endpoints.UsersavedAlbum,prop_constants.getProperty("status_code_200"));
	}
}
