...
public class Change_Playlist_Details extends BaseTest{
	...
	public void playlist(String SINO, String id,String ids,String savedAlbums,String queryparamkey,String pathParam ) {
		...
		File path = new File(prop_constants.getProperty("change_playlist_details"));
		ApiActionUtil.putMethodWithBody(queryparamkey, prop_constants.getProperty("playlistId"), id, path, Endpoints.PlaylistItems,prop_constants.getProperty("status_code_200"));
	}
}
